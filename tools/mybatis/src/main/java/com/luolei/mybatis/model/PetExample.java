...
public class PetExample {
     ...
     * @mbg.generated
     */
    protected Integer startIndexFrom0;
     ...
     * @mbg.generated
     */
    protected Integer endIndexFrom0;
    ...
    protected void addData() {
        if (this.pageNo != null && this.pageSize != null && this.pageNo != 0 && this.pageSize != 0) {
            this.startIndex = this.pageSize * (this.pageNo - 1) + 1;
            this.endIndex = this.pageSize * this.pageNo;
            this.startIndexFrom0 = this.startIndex - 1;
            this.endIndexFrom0 = this.endIndex - 1;
        }
    }

    /**
     * This class was generated by MyBatis Generator.
     * This class corresponds to the database table pets
     *
     * @mbg.generated
     */
