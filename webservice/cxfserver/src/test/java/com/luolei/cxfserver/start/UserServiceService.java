 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://start.cxfserver.luolei.com/", wsdlLocation = "http://127.0.0.1:9000/services/userService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://start.cxfserver.luolei.com/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9000/services/userService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://start.cxfserver.luolei.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://start.cxfserver.luolei.com/", "UserServicePort"), UserService.class, features);
    }
