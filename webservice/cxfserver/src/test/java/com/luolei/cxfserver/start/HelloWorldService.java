 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://start.cxfserver.luolei.com/", wsdlLocation = "http://127.0.0.1:9000/services/helloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://start.cxfserver.luolei.com/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9000/services/helloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://start.cxfserver.luolei.com/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://start.cxfserver.luolei.com/", "HelloWorldPort"), HelloWorld.class, features);
    }
